...
ALLOWED_HOSTS = ['localhost',
                 'https://mariizumi645-8000.theiadockernext-0-labs-prod-thei' +
                 'ak8s-4-tor01.proxy.cognitiveclass.ai']

CSRF_TRUSTED_ORIGINS = [
    'https://mariizumi645-8000.theiadockernext-0-labs-prod-theiak8s-4-tor01.' +
